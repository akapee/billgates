...
export function Claims() {
  ...
  return <div className="p-6 max-w-[1600px] mx-auto">
    ...
    {error ? <FirestoreError message={error} /> : loading ? <Loading /> : <><div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
...
function Loading() { return <div className="card p-10 text-center text-sm text-slate-500">Memuat data klaim dari Firestore...</div>; }
function FirestoreError({ message }: { message: string }) { return <div className="card p-5 text-sm text-red-700 bg-red-50">Gagal memuat data Firestore: {message}</div>; }
